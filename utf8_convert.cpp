...
{
	// convert the string
	int sizeNeeded = WideCharToMultiByte(CharSet_in, 0UL, String_in.c_str(), String_in.length(),
...
{
	// convert the string
	int sizeNeeded = MultiByteToWideChar(CharSet_in, 0UL, String_in.c_str(), String_in.length(),
